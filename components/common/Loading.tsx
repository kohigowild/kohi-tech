...
export function LoadingSpinner() {
  return (
    <div className='fixed top-0 left-0 w-full h-full flex items-center justify-center z-50 bg-gray-900 bg-opacity-20'>
      <div className='absolute top-1/2 left-1/2 -mt-4 -ml-2 h-8 w-4 text-[#4150A6]'>
